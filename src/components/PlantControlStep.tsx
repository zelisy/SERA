        ...
        <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    onUpdate(plantIndex, 'kokFoto', urls);
                  }}
                />
              </div>
            </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    const files = Array.from(e.target.files || []);
                    const urls = files.map(file => URL.createObjectURL(file));
                    onUpdate(plantIndex, 'drenajFoto', urls);
                  }}
                />
              </div>
            </div>
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Vejetatif kontrol problemi var mı?
                </label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Vejetatif Kontrol Fotoğrafları
                </label>
                <input
                  type="file"
                  multiple
                  ...
                  onChange={(e) => {
                    const files = Array.from(e.target.files || []);
                    const urls = files.map(file => URL.createObjectURL(file));
                    onUpdate(plantIndex, 'vejetatifFoto', urls);
                  }}
                />
              </div>
            </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    const files = Array.from(e.target.files || []);
                    const urls = files.map(file => URL.createObjectURL(file));
                    onUpdate(plantIndex, 'brixFoto', urls);
                  }}
                />
              </div>
            </div>
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Klorofil kontrol problemi var mı?
                </label>
                <select
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    const files = Array.from(e.target.files || []);
                    const urls = files.map(file => URL.createObjectURL(file));
                    onUpdate(plantIndex, 'klorofilFoto', urls);
                  }}
                />
              </div>
            </div>
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Generatif kontrol problemi var mı?
                </label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Generatif Kontrol Fotoğrafları
                </label>
                <input
                  type="file"
                  multiple
                  ...
                  onChange={(e) => {
                    const files = Array.from(e.target.files || []);
                    const urls = files.map(file => URL.createObjectURL(file));
                    onUpdate(plantIndex, 'generatifFoto', urls);
                  }}
                />
              </div>
            </div>
